  ...
  return (
    <Routes>
          ...
          <SpotifyLayout
            ...
            chieldren={
              <SpotifyMovie
                movies={movies ?? []}
                myMovieList={myMovieList ?? []}
                setMydMovieList={setMyMovieList}
                setSelectedMovie={setSelectedMovie}
                movie={
                  selectedMovie ?? {
                    _id: "",
          ...
          <SpotifyLayout
            ...
            chieldren={
              <BanerWidget
                ...
                setMymovieList={setMyMovieList}
                setSelectedMovie={setSelectedMovie}
                title={"อ้างอิงจากการดูล่าสุดของคุณ"}
                subTitle={"เเนะนําสําหรับวันนี้"}
                movies={movies ?? []}
              ></BanerWidget>
            }
            movies={movies ?? []}
      ...
      <Route
        ...
        element={
          <SpotifyLayout
            ...
            setMymovieList={setMyMovieList}
            setSelectedMovie={setSelectedMovie}
            chieldren={<TheatreManagePage></TheatreManagePage>}
            movies={movies ?? []}
            selectedMovie={
              selectedMovie ?? {
                _id: "",
      ...
      <Route
        ...
        element={
          <SpotifyLayout
            ...
            setMymovieList={setMyMovieList}
            setSelectedMovie={setSelectedMovie}
            chieldren={<MovieEditPage></MovieEditPage>}
            movies={movies ?? []}
            selectedMovie={
              selectedMovie ?? {
                _id: "",
      ...
      <Route
        ...
        element={
          <SpotifyLayout
            ...
            setMymovieList={setMyMovieList}
            setSelectedMovie={setSelectedMovie}
            chieldren={<MovieCreatePage></MovieCreatePage>}
            movies={movies ?? []}
            selectedMovie={
              selectedMovie ?? {
                _id: "",
      ...
      <Route
        ...
        element={
          <MainAppLayout
            children={<MovieEditPage></MovieEditPage>}
          ></MainAppLayout>
        }
      ></Route>
      <Route
        ...
        element={
          <MainAppLayout
            children={<MovieCreatePage></MovieCreatePage>}
          ></MainAppLayout>
        }
      ></Route>
